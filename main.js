...
document.getElementById("your_sketch").innerHTML="Result : "+results[0].label;
document.getElementById("confidence").innerHTML="Confidence : "+(results[0].confidence*100).toFixed(3);
}